...
Ai fini dell'esame dovrete mandare via e-mail i notebook (uno per task) usati per il pre-processing dei dati, l'addestramento dei modelli e la generazione delle predizioni.

I notebook dovranno essere già eseguiti e commentati, illustrando i vostri ragionamenti e scelte architetturari.

È necessario che il team leader invii la mail a nome del gruppo con oggetto _[NLP] consegna esame NOME_GRUPPO_, massimo una settimana prima della data dell'esame dal portale.
